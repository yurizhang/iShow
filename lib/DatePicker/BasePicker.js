  ...
  _createClass(BasePicker, null, [{
    ...
    get: function get() {
      return {
        ...
        isShowTrigger: _propTypes2.default.bool,
        ...
        // time select pannel:
        value: _propTypes2.default.oneOfType([_propTypes2.default.instanceOf(Date), _propTypes2.default.arrayOf(_propTypes2.default.instanceOf(Date))])
      };
    }
  }, {
    key: 'defaultProps',
