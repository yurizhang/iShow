...
require('../Common/css/Pagination.css');
...
var Pre = function Pre(props) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement('i', { className: 'ishow-icon ishow-icon-arrow-left' })
  );
};
...
var Next = function Next(props) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement('i', { className: 'ishow-icon ishow-icon-arrow-right' })
  );
};
        ...
        _react2.default.createElement(
          ...
          this.props.pageSizes.map(function (item, idx) {
            return _react2.default.createElement(_Select2.default.Option, {
              key: idx,
              value: item,
              label: item + ' ' + _locale2.default.t('ishow.pagination.pagesize')
            });
          })
        )
      );
...
var Total = function Total(props) {
  return typeof props.total === 'number' ? _react2.default.createElement(
    ...
    _locale2.default.t('ishow.pagination.total', { total: props.total })
  ...
  _createClass(Jumper, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _locale2.default.t('ishow.pagination.goto'),
        ...
        _locale2.default.t('ishow.pagination.pageClassifier')
      );
    }
  }]);
...
Pagination.propTypes = {
  ...
  pageSizes: _propTypes2.default.array,

  //Event
  onCurrentChange: _propTypes2.default.func,
