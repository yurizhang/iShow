  ...
  _createClass(Button, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        this.props.loading && _react2.default.createElement('i', { className: 'ishow-icon-loading' }),
        this.props.icon && !this.props.loading && _react2.default.createElement('i', { className: 'ishow-icon-' + this.props.icon }),
...
Button.propTypes = {
  ...
  nativeType: _propTypes2.default.string,
