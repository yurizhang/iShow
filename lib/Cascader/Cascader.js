...
require('../Common/css/Cascader.css');
  ...
  _createClass(Cascader, [{
    ...
    value: function highlightKeyword(label, keyword) {
      return label.split(keyword).map(function (node, index) {
        return index === 0 ? node : [_react2.default.createElement(
          'span',
          { className: 'ishow-cascader-menu__item__keyword' },
          keyword
        ), node];
      });
    }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'span',
        { ref: 'reference', className: this.className('ishow-cascader', size ? 'ishow-cascader--' + size : '', {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'span',
              { className: 'ishow-cascader__label' },
...
Cascader.propTypes = {
  ...
  showAllLevels: _propTypes2.default.bool,
  debounce: _propTypes2.default.number,
  activeItemChange: _propTypes2.default.func,
  beforeFilter: _propTypes2.default.func,
...
exports.default = (0, _reactClickOutside2.default)(Cascader);