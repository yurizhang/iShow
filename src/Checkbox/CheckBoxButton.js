...
export default class CheckboxButton extends CheckBox {
  ...
  render(){
    ...
    return (
      <label style={this.style()} className={this.className('ishowcheckbox-button', group.props.size ? 'ishowcheckbox-button--' + group.props.size : '', {
        ...
        />
        <span className="ishowcheckbox-button__inner" style={this.state.checked ? {
