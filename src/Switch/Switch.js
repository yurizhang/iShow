  ...
  render() {
    ...
    return (
      <label
        ...
        <View show={disabled}>
          <div className="ishow-switch__mask"></div>
        </View>
        ...
        <span className="ishow-switch__core" ref="core" style={{ 'width': coreWidth + 'px' }}>
          <span className="ishow-switch__button" style={Object.assign({}, buttonStyle)} onClick={this.setFocus.bind(this)}/>
        </span>
