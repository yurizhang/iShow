...
export default class TimeRangePanel extends PopperBase {
  ...
  render() {
    ...
    return (
      ...
      >
        <div className="ishow-time-range-picker__content">
          <div className="ishow-time-range-picker__cell">
            <div className="ishow-time-range-picker__header">
              {$t('el.datepicker.startTime')}
            </div>
            <div
              className={this.classNames(
                'ishow-time-range-picker__body ishow-time-panel__content',
        ...
        <div className="ishow-time-panel__footer">
          <button
            type="button"
