      ...
      >
        <div className="ishow-picker-panel__body-wrapper">
          ...
          <div className="ishow-picker-panel__body">
            {
              isShowTime && (
                <div className="ishow-date-range-picker__time-header">
                  <span className="ishow-date-range-picker__editors-wrap">
                    <span className="ishow-date-range-picker__time-picker-wrap">
                      <Input
                        size="small"
                        ref="minInput"
                  ...
                  <span className="ishow-icon-arrow-right"></span>
                  <span className="ishow-date-range-picker__editors-wrap is-right">
                    <span className="ishow-date-range-picker__time-picker-wrap">
                      <Input
                        size="small"
            ...
            <div className="ishow-picker-panel__content ishow-date-range-picker__content is-left">
              <div className="ishow-date-range-picker__header">
                <button
                  type="button"
                  onClick={this.prevYear.bind(this)}
                  className="ishow-picker-panel__icon-btn ishow-icon-d-arrow-left"></button>
                <button
                  type="button"
                  onClick={this.prevMonth.bind(this)}
                  className="ishow-picker-panel__icon-btn ishow-icon-arrow-left"></button>
                <div>{leftLabel}</div>
              </div>
              <DateTable
            ...
            <div className="ishow-picker-panel__content ishow-date-range-picker__content is-right">
              <div className="ishow-date-range-picker__header">
                <button
                  type="button"
                  onClick={this.nextYear.bind(this)}
                  className="ishow-picker-panel__icon-btn ishow-icon-d-arrow-right"></button>
                <button
                  type="button"
                  onClick={this.nextMonth.bind(this)}
                  className="ishow-picker-panel__icon-btn ishow-icon-arrow-right"></button>
                <div>{rightLabel}</div>
              </div>
              <DateTable
                selectionMode={SELECTION_MODES.RANGE}
          ...
          isShowTime && (
            <div className="ishow-picker-panel__footer">
              <a href="javascript:;"
                ...
                onClick={()=> this.handleClear()}>清除</a>
              <button
                type="button"
                className="ishow-picker-panel__btn"
                onClick={()=> this.handleConfirm()}
                disabled={this.btnDisabled}>确定</button>
            </div>
          )
        }
      </div>
